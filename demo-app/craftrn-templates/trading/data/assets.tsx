...
export const assets: AssetsData = [
  ...
  },
  {
    ...
    change: '-0.64%',
    imageURL:
      'https://static-00.iconduck.com/assets.00/binance-icon-2048x2048-eh77cmwj.png',
  },
  {
  ...
  },
  {
    ...
    change: '-0.36%',
    imageURL:
      'https://static-00.iconduck.com/assets.00/stellar-cryptocurrency-icon-512x512-xz8auw3z.png',
  },
  {
    id: '5503557c-3726-400b-8001-35c5858860e3',
    type: 'shares',
    name: 'Alphabet',
    pairing: 'GOOGL to USD',
    sellPrice: '167.18',
    fromSymbol: 'GOOGL',
    toSymbol: '$',
    change: '+0.48%',
